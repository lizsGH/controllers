...
//        pclose($ipfh);
       ...
       // var_dump($res);die;
        ...
        if(!isset($_SESSION['username']) && parse_url(Yii::$app->request->url)['path']!= '/jxhc_report/index' &&  parse_url(Yii::$app->request->url)['path']!= '/bbgl/htmltoimg' && Yii::$app->request->url!='/site/login' && !stripos(Yii::$app->request->url ,'captcha')){
    ...
    public function init()
    {
        ...
        //var_dump( parse_url(Yii::$app->request->url)['path']);die;
        if(empty($username) && parse_url(Yii::$app->request->url)['path']!= '/jxhc_report/index' && parse_url(Yii::$app->request->url)['path']!= '/bbgl/htmltoimg' && Yii::$app->request->url!='/site/login' && !stripos(Yii::$app->request->url ,'captcha')){
            return $this->redirect('/site/login')->send();
        }
