...
//                $content = str_replace('{common.css}', Yii::$app->request->hostInfo.'/report/common.css', $content);
//                $content = str_replace('{bluechar.js}', Yii::$app->request->hostInfo.'/report/bluechar.js', $content);
//                $content = str_replace('{common.js}', Yii::$app->request->hostInfo.'/report/common.js', $content);
//                $content = str_replace('{jquery-1.9.1.min.js}', Yii::$app->request->hostInfo.'/report/jquery-1.9.1.min.js', $content);

                $content = str_replace('{image_sg}', Yii::$app->request->hostInfo.'/report/7.png', $content);
